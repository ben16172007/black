...
<input type='submit'  name='change' value='更改會員資料'>
</form>
</div>
	<?PHP	
	error_reporting(E_ALL ||	 E_NOTICE);
	 $username = $_SESSION["username"];
	 if (!isset($_POST['change'])&&!isset($_POST['logout'])){
	 echo"<script>";
	 echo"alert('歡迎您！";
	 echo $username;
	 echo"');";
